...
-   altibase.properties: the configuration file for Altibase. For more detailed information on the configurable properties, please refer to the *[General Reference-1.Data Types & Altibase Properties](../General%20Reference-1.Data%20Types%20&%20Altibase%20Properties/2.-Altibase-Properties.md)*.
-   license: the Altibase license file
-   dblink.conf: the configuration file for database link. For more detailed information on the configurable properties, please refer to the *[General Reference-1.Data Types & Altibase Properties](../General%20Reference-1.Data%20Types%20&%20Altibase%20Properties/2.-Altibase-Properties.md)*.
-   aexport.properties: the configuration file for aexport. For more detailed information on the configurable properties, please refer to the *[Utilities Manual](../../tool/Utilities%20Manual/4.-Other-Utilities.md)*.
-   syspassword: the file password of sys user is stored. For more detailed information on how to use this file, please refer to the *[Utilities Manual](../../tool/Utilities%20Manual/4.-Other-Utilities.md#altipasswd)*.
...
This is explained in detail in the *[Getting Started Guide](../getting-started-guide/0.-Preface.md#preface)*.
